        ...
        <v-card-text>
          ...
          <v-row justify="end" class="education-experience-read-more-button">
            <v-dialog v-model="closeDialog" width="1100px" scroll-strategy="none">
              ...
              <v-card class="education-dialog-card">
                <v-card-title class="text-center card-title education-dialog-title">
                  <h4> {{ detailCardTitle }} </h4>
                </v-card-title>
                <v-divider/>
                <v-card-text class="education-dialog-body">
                ...
                <v-card-actions class="education-dialog-actions">
                  <v-spacer></v-spacer>
